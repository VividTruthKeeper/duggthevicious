...
const Offer = ({ description, benefit, name }: IProps) => {
  ...
  return (
    ...
    >
      ...
      >
        <Image src="/globe.svg" alt="offer" width={60} height={60} className="object-contain w-[60px] h-full" />
      </motion.div>
      <div className="flex flex-col gap-3">
        <div className="flex items-center gap-[10px] justify-between">
          <motion.h3
            ...
            initial={{
              fontSize: breakpoints["640"] ? "22px" : breakpoints["768"] ? "26px" : "32px",
            }}
            animate={
              open
                ? {
                ...
                : {
                    fontSize: breakpoints["640"] ? "18px" : breakpoints["768"] ? "21px" : "24px",
                  }
            }
          >
            {name}
          ...
          >
            <Image src="/globe.svg" alt="offer" width={36} height={36} className="object-contain w-[36px] h-full" />
          </motion.div>
        </div>
